...
pub struct OpencodePluginComponents {
    ...
    pub hook_files: Vec<OpencodePluginComponentPath>,
    pub mcp_files: Vec<OpencodePluginComponentPath>,
}
...
impl OpencodePluginComponents {
    pub fn counts(&self) -> OpencodeComponentCounts {
        OpencodeComponentCounts {
            ...
            hook_files: self.hook_files.len(),
            mcp_files: self.mcp_files.len(),
        }
    }
}
...
impl OpencodePluginComponentInspector for FilesystemPluginComponentInspector {
    fn inspect_components(&self, plugin_dir: &Path) -> OpencodePluginComponents {
        discover_plugin_components(plugin_dir)
    }
}

pub fn discover_plugin_components(plugin_dir: &Path) -> OpencodePluginComponents {
    OpencodePluginComponents {
        commands: discover_commands(plugin_dir),
        scripts: discover_scripts(plugin_dir),
        tools: discover_tools(plugin_dir),
        hook_files: Vec::new(),
        mcp_files: Vec::new(),
    }
}
